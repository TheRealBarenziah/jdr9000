...
module.exports = {
  ...
  execute(msg, args) {
    ...
    if ((args[0] === "man") && (args.length === 1)) {
      ...
      msg.author.send("Command invalid: try **/man jdr9000** (or **/man *command*** to learn about a specific command)");
    }
  }
};
